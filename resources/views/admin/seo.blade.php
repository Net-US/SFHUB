    ...
    <div class="animate-fade-in-up space-y-6">
        ...
        <div class="bg-white dark:bg-stone-900 rounded-2xl p-2 border border-stone-200 dark:border-stone-800">
            <div class="flex gap-2 overflow-x-auto">
                <button onclick="switchTab('global')"
                ...
                <button onclick="switchTab('pages')"
                ...
                <button onclick="switchTab('metatags')"
                    class="tab-btn px-4 py-2 rounded-lg text-sm font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-800"
                    data-tab="metatags">
                    <i class="fa-solid fa-tags mr-1"></i> Meta Tags
                </button>
                <button onclick="switchTab('sitemap')"
                    class="tab-btn px-4 py-2 rounded-lg text-sm font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-800"
                    data-tab="sitemap">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="global-title"
                            value="{{ $globalSeo?->default_title ?? 'Student-Freelancer Hub' }}"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">Default
                            Description</label>
                        <textarea id="global-description" rows="3"
                            class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-stone-800 dark:text-white">{{ $globalSeo?->default_description ?? 'Platform terpadu untuk mahasiswa dan freelancer Indonesia' }}</textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">Default
                            Keywords</label>
                        <input type="text" id="global-keywords"
                            value="{{ $globalSeo?->default_keywords ?? 'mahasiswa, freelancer, manajemen tugas, keuangan, kalender' }}"
                            class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-stone-800 dark:text-white">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="global-author" value="{{ $globalSeo?->author ?? 'SFHUB Team' }}"
                            class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-stone-800 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">Robots</label>
                        <select id="global-robots"
                            class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-stone-800 dark:text-white">
                            <option value="index, follow"
                                {{ ($globalSeo?->robots ?? 'index, follow') === 'index, follow' ? 'selected' : '' }}>index,
                                follow</option>
                            <option value="index, nofollow"
                                {{ ($globalSeo?->robots ?? '') === 'index, nofollow' ? 'selected' : '' }}>index, nofollow
                            </option>
                            <option value="noindex, follow"
                                {{ ($globalSeo?->robots ?? '') === 'noindex, follow' ? 'selected' : '' }}>noindex, follow
                            </option>
                            <option value="noindex, nofollow"
                                {{ ($globalSeo?->robots ?? '') === 'noindex, nofollow' ? 'selected' : '' }}>noindex,
                                nofollow</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">Google Analytics
                            ID</label>
                        <input type="text" id="global-analytics" value="{{ $globalSeo?->google_analytics_id ?? '' }}"
                            placeholder="UA-12345678-1 or G-XXXXXXXXXX"
                            class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-stone-800 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">Facebook Pixel
                            ID</label>
                        <input type="text" id="global-pixel" value="{{ $globalSeo?->facebook_pixel_id ?? '' }}"
                            placeholder="FB-PIXEL-123"
                            class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-stone-800 dark:text-white">
                    </div>
                    <div class="flex items-center gap-2">
                        <input type="checkbox" id="global-analytics-active"
                            {{ $globalSeo?->analytics_active ? 'checked' : '' }}
                            class="rounded border-stone-300 text-primary-600 focus:ring-primary-500">
                        <label for="global-analytics-active" class="text-sm text-stone-700 dark:text-stone-300">Enable
        ...
        <div id="tab-pages"
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-2">
                    <button onclick="addPageSEO()"
                        class="flex items-center gap-2 px-3 py-2 bg-stone-600 hover:bg-stone-700 text-white rounded-lg text-sm">
                        <i class="fa-solid fa-plus"></i> Add SEO Page
                    </button>
                    <a href="{{ route('admin.seo.pages.create') }}"
                        ...
                        <i class="fa-solid fa-file-alt"></i> Create Static Page
                    </a> </a>
                </div>
            </div>
            ...
            <div class="mb-8">
                <h4 class="text-sm font-semibold text-stone-700 dark:text-stone-300 mb-4">Static Pages (About, Contact,
                    etc.)</h4>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-stone-200 dark:border-stone-700">
                                ...
                                <th class="text-left py-3 text-stone-600 dark:text-stone-400 font-medium">Status</th>
                                <th class="text-left py-3 text-stone-600 dark:text-stone-400 font-medium">Published</th>
                                <th class="text-left py-3 text-stone-600 dark:text-stone-400 font-medium">Actions</th>
                            </tr>
                        </thead>
                        <tbody id="static-pages-tbody">
                            @forelse($staticPages ?? [] as $page)
                                <tr
                                    ...
                                    <td class="py-3 font-medium text-stone-800 dark:text-white">{{ $page->title }}</td>
                                    <td class="py-3">
                                        <span
                                            class="text-xs bg-stone-100 dark:bg-stone-800 px-2 py-1 rounded">{{ $page->slug }}</span>
                                    </td>
                                    <td class="py-3">
                                        <span
                                            class="text-xs px-2 py-1 rounded {{ $page->status === 'published' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400' }}">
                                            {{ $page->status === 'published' ? 'Published' : 'Draft' }}
                                        </span>
                                    </td>
                                    <td class="py-3 text-xs text-stone-500">
                                        {{ $page->published_at?->format('d M Y') ?? 'Not published' }}
                                    </td>
                                    <td class="py-3">
                                        <div class="flex gap-2">
                                            ...
                                            <button onclick="deleteStaticPage({{ $page->id }})"
                                                class="text-rose-600 hover:text-rose-800 dark:text-rose-400"
                                                title="Delete Page">
                                ...
                                <tr>
                                    <td colspan="5" class="py-8 text-center text-stone-500">
                                        <div class="text-center">
                                            <i class="fa-solid fa-file-alt text-2xl mb-2 text-stone-400"></i>
                                            <p>No static pages yet</p>
                                            <p class="text-xs mt-1">Create your first static page like About, Contact, etc.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
            ...
            <!-- SEO Settings Pages Section -->
            <div>
                <h4 class="text-sm font-semibold text-stone-700 dark:text-stone-300 mb-4">SEO Settings for Dynamic Pages
                </h4>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead>
                        ...
                        <tbody>
                            @forelse($pageSeo ?? [] as $seo)
                                <tr class="border-b border-stone-100 dark:border-stone-800 hover:bg-stone-50 dark:hover:bg-stone-800 page-seo-row"
                                    data-id="{{ $seo->id }}">
                                    ...
                                    <td class="py-3">
                                        <div class="flex gap-2">
                                            ...
                                            <button onclick="deletePageSEO({{ $seo->id }})"
                                                class="text-rose-600 hover:text-rose-800 dark:text-rose-400">
                                                <i class="fa-solid fa-trash-can"></i>
                                            </button>
                                        </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="py-8 text-center text-stone-500">No page SEO settings yet
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        <div id="tab-metatags"
            ...
            <div class="space-y-3" id="metatags-list">
                @forelse($metaTags ?? [] as $tag)
                    <div class="meta-tag-item flex items-center gap-4 p-4 border border-stone-200 dark:border-stone-700 rounded-lg"
                        data-id="{{ $tag->id }}">
                        <select
                            class="tag-type w-32 border border-stone-300 dark:border-stone-700 rounded-lg px-3 py-2 text-sm dark:bg-stone-800 dark:text-white">
                            <option value="name" {{ $tag->type === 'name' ? 'selected' : '' }}>name</option>
                            <option value="property" {{ $tag->type === 'property' ? 'selected' : '' }}>property</option>
                            <option value="http-equiv" {{ $tag->type === 'http-equiv' ? 'selected' : '' }}>http-equiv
                            </option>
                        </select>
                        <input type="text" value="{{ $tag->name }}" placeholder="Tag name"
                            class="tag-name flex-1 border border-stone-300 dark:border-stone-700 rounded-lg px-3 py-2 text-sm dark:bg-stone-800 dark:text-white">
                        <input type="text" value="{{ $tag->content }}" placeholder="Content"
                            class="tag-content flex-1 border border-stone-300 dark:border-stone-700 rounded-lg px-3 py-2 text-sm dark:bg-stone-800 dark:text-white">
                ...
                <div class="lg:col-span-2 space-y-4">
                    <div class="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-800 rounded-xl">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" id="sitemap-auto" {{ $sitemap?->auto_generate ? 'checked' : '' }}
                                class="sr-only peer">
                            <div
                                class="w-11 h-6 bg-stone-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-stone-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-stone-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-stone-600 peer-checked:bg-primary-600">
                            </div>
                        </label>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">Sitemap
                                Path</label>
                            <input type="text" id="sitemap-path"
                                value="{{ $sitemap?->sitemap_path ?? 'sitemap.xml' }}"
                                class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-stone-800 dark:text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">Last
                                Generated</label>
                            <input type="text"
                                value="{{ $sitemap?->last_generated?->format('Y-m-d H:i:s') ?? 'Never' }}" readonly
                                class="w-full border border-stone-300 dark:border-stone-700 rounded-xl px-4 py-2 bg-stone-100 dark:bg-stone-800 text-stone-500">
                        </div>
                    </div>
                    <div class="flex gap-3">
                        <button onclick="generateSitemap()"
                            class="flex-1 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-medium">
                            <i class="fa-solid fa-sync-alt mr-2"></i> Generate Now
                        </button>
                        <a href="{{ route('admin.seo.sitemap.download') }}"
                            class="flex-1 py-3 border border-stone-300 dark:border-stone-700 hover:bg-stone-50 dark:hover:bg-stone-800 rounded-xl font-medium text-center">
                ...
                <div class="bg-stone-50 dark:bg-stone-800 rounded-xl p-4">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-medium text-emerald-600">{{ $sitemap?->last_generated ? 'Generated' : 'Not Generated' }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function saveGlobalSEO() {
            ...
            fetch('{{ route('admin.seo.global.update') }}', {
                ...
                .then(data => {
                    if (data.success) {
                        showNotification('Global SEO settings saved', 'success');
                    } else {
        ...
        function addMetaTag() {
            ...
            div.className =
                'meta-tag-item flex items-center gap-4 p-4 border border-stone-200 dark:border-stone-700 rounded-lg';
            div.dataset.id = id;
            div.innerHTML = `
            ...
            if (confirm('Apakah Anda yakin ingin menghapus halaman ini? Tindakan ini tidak dapat dibatalkan.')) {
                fetch(`{{ url('admin/seo/pages') }}/${pageId}`, {
                    ...
                    .catch(error => {
                        ...
                        showNotification('Terjadi kesalahan saat menghapus halaman.', 'error');
                    });
            }
        }
    </script>
