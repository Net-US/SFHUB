<!-- Hero Section -->
<header class="pt-32 pb-20 hero-gradient relative overflow-hidden">
    ...
    <div
        class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        <div>
            @if ($hero)
                <span
            ...
            @else
                ...
                <p class="text-lg text-stone-600 dark:text-stone-300 mb-8 leading-relaxed max-w-lg">
                    ...
                    Atur proyek kreatif, tugas kampus, freelance, dan kehidupan pribadi dalam satu dashboard
                    terintegrasi.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    @guest
            ...
            <div
                class="flex items-center gap-3 px-6 py-4 bg-white/50 dark:bg-stone-800/50 rounded-xl backdrop-blur-sm mt-6">
                <div class="flex -space-x-2">
                    <div class="w-8 h-8 rounded-full border-2 border-white dark:border-stone-800 bg-blue-400"></div>
                    <div class="w-8 h-8 rounded-full border-2 border-white dark:border-stone-800 bg-emerald-400"></div>
                    <div class="w-8 h-8 rounded-full border-2 border-white dark:border-stone-800 bg-orange-400"></div>
                    <div class="w-8 h-8 rounded-full border-2 border-white dark:border-stone-800 bg-purple-400"></div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-xs font-bold text-emerald-600 dark:text-emerald-400">⏰ Hari
                                    Ini</span>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase">
                                        Proyek Kreatif</p>
                                    <p class="font-bold text-stone-800 dark:text-stone-200">Edit Video Klien</p>
                                </div>
                                <span class="text-xs font-bold text-blue-600 dark:text-blue-400">📅 2 Hari
                                    Lagi</span>
                            </div>
                        </div>
                        <div
